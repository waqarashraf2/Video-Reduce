    ...
    <footer className="border-t border-white/[0.08] bg-[#05080e] pt-16 pb-12 text-slate-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400 max-w-sm">
              The high-performance, WebAssembly-powered media suite on <strong>VideoReduce.com</strong>. A product of the <strong>Verse Next</strong> innovation ecosystem.
            </p>
            ...
            <div className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-950/60 to-indigo-950/60 p-3 ring-1 ring-blue-500/20 text-xs text-blue-300">
              ...
              <span>
                <strong>Verse Next Product</strong> • 100% Free & Open Web Tool
              </span>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/[0.08] pt-8 sm:flex-row text-xs text-slate-400">
          <p>© {new Date().getFullYear()} VideoReduce.com — An Innovation by <strong>Verse Next</strong>.</p>
