  ...
  return (
    <div className="relative min-h-screen bg-white py-12 sm:py-20 text-slate-900">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-10">
          {faqCategories.map((cat, idx) => (
            <div key={idx} className="space-y-4">
              <h2 className="text-xl font-black text-slate-950 flex items-center gap-2 border-b border-slate-200 pb-2.5">
        ...
        {/* Contact CTA */}
        <div className="rounded-3xl border border-red-200 bg-gradient-to-br from-red-50 via-white to-rose-50 p-8 text-center space-y-4 shadow-sm">
          <h3 className="text-xl font-black text-slate-950">Still Have Questions?</h3>
          <p className="text-xs sm:text-sm text-slate-600 max-w-xl mx-auto">
            Our engineering team is here to assist with custom codec parameters, bug reports, and partnership inquiries.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-600 via-rose-600 to-red-600 px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-red-500/25 hover:brightness-110 active:scale-95 transition-all"
          >
