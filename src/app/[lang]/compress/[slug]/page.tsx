  ...
  () => import("@/components/tools/ToolRunner").then((m) => m.ToolRunner),
  {
    ...
    loading: () => (
      <div className="flex flex-col items-center justify-center p-8 space-y-3">
        ...
        <span className="text-xs text-slate-600 font-medium">Loading Compressor...</span>
      </div>
    ),
  }
);
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <header className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-1 text-xs text-slate-600">
            <div className="flex items-center gap-1.5 rounded-lg bg-slate-50 px-3 py-1.5 border border-slate-200 shadow-sm">
              <span className="font-bold text-slate-900">{t.targetLimit}</span>
              <span className="text-red-600 font-mono font-bold">{useCase.targetSizeText}</span>
            </div>
            <div className="flex items-center gap-1.5 rounded-lg bg-slate-50 px-3 py-1.5 border border-slate-200 shadow-sm">
              <span className="font-bold text-slate-900">{t.recommendedPreset}</span>
