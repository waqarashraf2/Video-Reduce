    ...
    <div className="relative min-h-screen bg-white py-12 sm:py-20 text-slate-900">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl font-black tracking-tight text-slate-950 sm:text-5xl lg:text-6xl leading-[1.15]">
            How Video Reducer{" "}
          ...
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
            ...
            <strong className="text-slate-950 font-bold">10MB to 10GB+</strong> directly on your device with zero cloud uploads, infinite privacy, and no quality loss.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
            <div className="text-2xl sm:text-3xl font-black text-emerald-600 font-mono">0 Bytes</div>
            <div className="text-xs text-slate-500 font-semibold mt-1">Uploaded to Cloud</div>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
            <div className="text-2xl sm:text-3xl font-black text-red-600 font-mono">10MB–10GB+</div>
            <div className="text-xs text-slate-500 font-semibold mt-1">File Support Range</div>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
            <div className="text-2xl sm:text-3xl font-black text-slate-950 font-mono">Up to 90%</div>
            <div className="text-xs text-slate-500 font-semibold mt-1">Size Reduction</div>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
            <div className="text-2xl sm:text-3xl font-black text-red-600 font-mono">Wasm SIMD</div>
            <div className="text-xs text-slate-500 font-semibold mt-1">Hardware Accelerated</div>
          </div>
        </div>

        {/* Deep Dive Engineering Breakdown */}
        <div className="space-y-8 rounded-3xl border border-slate-200 bg-white p-6 sm:p-10 text-slate-700 leading-relaxed text-sm sm:text-base shadow-sm">
          {/* Section 1 */}
          <section className="space-y-4">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              <strong className="text-slate-900">Video Reducer</strong> eliminates remote servers entirely. By compiling the complete, industry-standard <strong className="text-slate-900">FFmpeg</strong> multimedia engine into high-performance <strong className="text-slate-900">WebAssembly (Wasm)</strong> with <strong className="text-slate-900">SIMD vector instructions</strong>, raw video transcoding operations execute directly inside your web browser at near-native CPU speeds.
            </p>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-slate-200">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              When you drop a file into Video Reducer, JavaScript mounts your file in an isolated <strong className="text-slate-900">Virtual File System (MEMFS)</strong> allocated strictly within your device&apos;s local RAM.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              ...
              <div className="rounded-2xl border border-red-200 bg-red-50/60 p-4 space-y-1.5">
          ...
          <section className="space-y-4 pt-8 border-t border-slate-200">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Because all calculations run locally on your device hardware, Video Reducer imposes no artificial file size ceilings. Whether you are compressing a small <strong className="text-slate-900">10MB phone recording</strong> for a quick text message, a <strong className="text-slate-900">500MB Discord gameplay clip</strong>, or a massive <strong className="text-slate-900">1GB to 10GB+ 4K UHD video</strong> from a DSLR camera or drone, the engine processes it with full fidelity.
            </p>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-slate-200">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-slate-600 pt-1">
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-slate-900">Psycho-Visual CRF Rate Control (CRF 23–28):</strong> Allocates higher bitrates to complex focal areas (faces, sharp text, rapid motion) while heavily compressing invisible background gradients.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-600 font-bold">✓</span>
                <span><strong className="text-slate-900">Dynamic Bitrate Ceilings:</strong> Automatically calculates the exact maximum bitrate required for platforms like Discord (8MB/25MB) and WhatsApp (16MB) to ensure seamless delivery.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-600 font-bold">✓</span>
                <span><strong className="text-slate-900">H.264 (AVC) & AAC Audio Transcoding:</strong> Produces universal MP4 files playable on every iPhone, Android, Mac, Windows, and Smart TV without compatibility errors.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-slate-200">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Intensive media operations are offloaded into background <strong className="text-slate-900">Web Worker threads</strong>. Using <code>SharedArrayBuffer</code> and multi-core CPU distribution, your device encodes video frames in parallel while keeping the browser UI completely responsive, smooth, and interactive.
            </p>
          </section>
        </div>

        {/* Action Callout */}
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 sm:p-10 text-center space-y-6 shadow-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-600 via-rose-600 to-red-600 px-6 py-3 text-sm font-bold text-white shadow-xl shadow-red-500/25 hover:brightness-110 active:scale-95 transition-all"
            >
            ...
            <Link
              href="/"
              className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold text-slate-800 hover:text-red-600 hover:border-red-300 shadow-sm transition-all"
            >
